...
const conditionalLoginForMarketPlaceInvestor = () => {
    return cy.marketplaceLogin(Cypress.env('invusername'), Cypress.env('invpassword'))
}
...
const generalActions = {
    ...
    conditionalLoginForMarketPlaceInvestor
