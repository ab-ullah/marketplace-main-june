...
const countryHeading = "h1"
//".sc-kJNqyW"
// old ".sc-clGGWX"
const countryDesctiption = "div"
...
const nextButtomTaxForm = "button.btn-primary"
//'.sc-geBCVM'
//2nd Form
const secondFormBackButton = '.sc-biHcxt'
//".sc-fiCYzP"
...
const taxableYearLabel = ".sc-fnebDD > :nth-child(6)"
const taxableYearLabelIn = ".sc-fnebDD > :nth-child(5)"
//old ".sc-dHMioH > :nth-child(6)"

const nextButtonClick = ".sc-igOmtu"
const nextButtonClicktax = "button.btn-primary"
//".sc-clGGWX"
//old '.sc-geBCVM'

const tablePresent = 'div[class="MuiPaper-root MuiTableContainer-root MuiPaper-elevation1 MuiPaper-rounded"]'
...
const taxFormNextButton = "button.btn-primary"
...
const changeFormsButton = ".sc-kJNqyW"
//old ".sc-fiCYzP"
