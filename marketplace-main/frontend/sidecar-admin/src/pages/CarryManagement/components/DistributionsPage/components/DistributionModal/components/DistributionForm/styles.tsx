...
export const CustomTabButton = styled.button<{selected?:boolean}>`
background: transparent;
border: none;
padding: 18px 0px;
color: ${props=>props.selected ? `#3A8DDF` : "black"} ;
border-bottom: ${props=>props.selected ? `2px solid #3A8DDF` : "none"} ;
:hover{
color: #3A8DDF;
}
