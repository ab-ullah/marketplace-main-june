...
find /usr/share/nginx/html/static/js/ -type f -exec sed -i -e "s,XX_REACT_APP_INVESTOR_URL_XX,${REACT_APP_INVESTOR_URL},g" {} \;
find /usr/share/nginx/html/static/js/ -type f -exec sed -i -e "s,XX_REACT_APP_MP_URL_XX,${REACT_APP_MP_URL},g" {} \;
nginx -g 'daemon off;'