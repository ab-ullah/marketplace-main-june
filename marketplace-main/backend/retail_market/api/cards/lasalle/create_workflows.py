...
class LasalleWorkFlowCreator(BaseCustomKYCCardsCreator):
...
def create_lasalle_workflows_for_company(company: Company):
    workflow_creator = LasalleWorkFlowCreator(company=company, workflow_types=WorkflowTypes)
