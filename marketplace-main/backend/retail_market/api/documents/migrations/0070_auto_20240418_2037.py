...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('documents', '0069_auto_20240329_1112'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='InvestorAccountCodeBulkUpdateDocument',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('document', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='investor_account_code_bulk_update_document', to='documents.document')),
                ('fund', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='funds.fund')),
            ],
            options={
                'abstract': False,
            },
