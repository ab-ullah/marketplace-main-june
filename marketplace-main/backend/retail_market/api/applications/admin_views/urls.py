...
ADMIN_INVESTOR_ACCOUNT_CODE_BULK_UPDATE = 'admin-investor-account-codes-bulk-update'
...
urlpatterns = [
    ...
    path(
        'funds/<fund_external_id>/investor-account-codes',
        applications.ApplicationInvestorAccountCodesBulkUpdate.as_view(),
        name=ADMIN_INVESTOR_ACCOUNT_CODE_BULK_UPDATE
    ),
    re_path(
