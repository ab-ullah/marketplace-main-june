...
from api.constants.headers import API_KEY_HEADER, VIEW_AS_COMPANY_USER_ID, SHOW_UNPUBLISHED_FUNDS, \
    VESTING_CALCULATION_DATE, ADVISOR_VIEW_AS_USER_ID
...
MIDDLEWARE = [
    ...
    'api.libs.middlewares.partner_api_logger.PartnerAPILogMiddleware'
]
...
DYNAMO_BASE_URL = env.str('DYNAMO_BASE_URL', '')
DYNAMO_API_KEY = env.str('DYNAMO_API_KEY', '')
...
KYC_EXPIRATION_EMAIL_RECIPIENT = env('KYC_EXPIRATION_EMAIL_RECIPIENT', default=None)
...
IS_TEST_RUN = env('IS_TEST_RUN', default=False)

CURRENCY_RATES_API_BASE_URL = env.str('CURRENCY_RATES_API_BASE_URL', '')
CURRENCY_RATES_API_KEY = env.str('CURRENCY_RATES_API_KEY', '')
